...
using ServiceLocationExample.Controllers;
using ServiceLocationExample.Models;

[assembly: WebActivator.PreApplicationStartMethod(typeof(ServiceLocationExample.AppStart_SQLCEEntityFramework), "Start")]

namespace ServiceLocationExample {
    public static class AppStart_SQLCEEntityFramework {
        public static void Start() {
            ...
            DbDatabase.SetInitializer(new UsersDbContextInitializer());
        }
    }
